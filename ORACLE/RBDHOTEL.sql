...
BEGIN
  ...
  SELECT ID_POKOJU INTO P_ID_POKOJU FROM REZERWACJE WHERE ID_REZERWACJI = P_ID_REZERWACJI;
  SELECT COUNT(*) INTO TEMP FROM POKOJE WHERE ID_POKOJU = P_ID_POKOJU AND NR_POKOJU = P_NR_POKOJU;
  IF TEMP = 0 THEN
    RAISE_APPLICATION_ERROR(-20007, 'POKÓJ NIE ISTNIEJE');
  END IF;
  ...
  VALUES(P_ID_HOTELU, P_NR_POKOJU, P_ID_REZERWACJI, P_OPIS, GODZINA_POCZATEK, GODZINA_KONIEC);
