...
BEGIN
  ...
  WHERE ULICA=ULICA AND NR_DOMU=NR_DOMU AND NR_MIESZKANIA=NR_MIESZKANIA AND MIEJSCOWOSC=MIEJSCOWOSC AND KOD_POCZTOWY=KOD_POCZTOWY AND KRAJ=KRAJ AND ROWNUM = 1));
...
BEGIN
  ...
  VALUES((SELECT ID_OSOBY FROM DANE_PERSONALNE WHERE IMIE=IMIE AND NAZWISKO=NAZWISKO AND EMAIL=EMAIL AND NR_TELEFONU=NR_TELEFONU), 1);
END DODAJ_KLIENTA;
/
-------------- ---------------------- -------------- 
-------------- -- DODAJ PRACOWNIKA -- -------------- 
...
BEGIN
  ...
  VALUES((SELECT ID_OSOBY FROM DANE_PERSONALNE WHERE IMIE=IMIE AND NAZWISKO=NAZWISKO AND EMAIL=EMAIL AND NR_TELEFONU=NR_TELEFONU AND ROWNUM=1), ID_HOTELU, SYSDATE, PENSJA, STANOWISKO);
...
BEGIN
  ...
  VALUES(ID_HOTELU, ID_KLIENTA, ID_POKOJU, PRZYJAZD, ODJAZD); 
END DODAJ_REZERWACJE;
/
SELECT TO_DATE('2024\1\6') A FROM DUAL;
BEGIN
DODAJ_REZERWACJE(1, 2, 1, TO_DATE('2024\10\6'), TO_DATE('2024\10\6'));
END;
SELECT * FROM HOTELE;
SELECT * FROM KLIENCI;
SELECT * FROM POKOJE;
